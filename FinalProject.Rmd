...
Assam Model 3: LASSO #Juliet Code
...
predictions <- bind_cols(
  mp_test,
  predict(object = cart_fit_classification, new_data = mp_test),
  predict(object = cart_fit_classification, new_data = mp_test, type = "prob")
)
```
